...
<body>
    ...
    <main>
        ...
        <div class="slider-area position-relative fix">
            ...
            <div class="stock-text">
                <h2> Custom Gelang Karet & Gantungan Kunci Berkualitas</h2>
            </div>
            <!-- Arrow -->
            <div class="thumb-content-box">
                <div class="thumb-content">
                    <h3>Lihat koleksi kami sekarang</h3>
        ...
        <section class="container my-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <p>
                        <strong>Ray’s Souvenir</strong> adalah produsen <strong>souvenir karet di Bandung</strong>
                        yang melayani pembuatan gelang karet custom dan gantungan kunci karet untuk
                        event perusahaan, sekolah, komunitas, dan promosi brand.
                        Produksi langsung dari Bandung dengan kualitas tinggi dan harga kompetitif.
                    </p>
                </div>
            </div>
        </section>
    ...
    <!-- Scroll Up -->
    <div id="back-top">
        <a title="Kembali ke Atas" href="#"> <i class="fas fa-level-up-alt"></i></a>
    </div>
